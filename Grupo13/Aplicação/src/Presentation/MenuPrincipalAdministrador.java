...
public class MenuPrincipalAdministrador extends javax.swing.JFrame {
     ...
     */
    public MenuPrincipalAdministrador(Actor a) {
        this.logado=a;
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton4.setText("Registar Despesa");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        RegistarDespesa r = new RegistarDespesa(logado);
        r.setVisible(true);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ConsultarDespesasAdministrador c = new ConsultarDespesasAdministrador(logado);
        c.setVisible(true);
        this.setVisible(false);
        this.dispose();
    ...
    private void InformacoesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_InformacoesActionPerformed
        this.setVisible(false);
        InformacoesAdministrador i = new InformacoesAdministrador(logado);
        i.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuPrincipalAdministrador(logado).setVisible(true);
            }
        });
    }
